 ...
 * @param [args.selectionHandleBehavior = 'none'] - When set to a value other than none a handle will appear in the lower right corner of the desktop version of the grid.  It does nothing but will be used in a future version of the grid.
...
declare class canvasDatagrid {
     ...
     */
    static selectColumn(columnIndex: number, toggleSelectMode: boolean, shift: boolean, supressSelectionchangedEvent: boolean): void;
    /**
     * Selects a row.
     ...
     * @returns selection.
     */
    static getSelectionBounds(): rect;
    /**
     ...
     */
    static selectArea(bounds: rect): void;
    /**
